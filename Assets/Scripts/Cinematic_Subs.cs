...
public class Cinematic_Subs : MonoBehaviour
{
    ...
    IEnumerator SubsSequence()
    {
        ...
        textox.GetComponent<Text>().text = "Stranger: Hmm, it doesn’t seem like you are under any trouble, but just to be sure, let me check your vitals…";
        yield return new WaitForSeconds(5.5f);
        textox.GetComponent<Text>().text = "Stranger: Great! You’re doing as well as could be expected from someone in your situation.";
        ...
        textox.GetComponent<Text>().text = "Stranger: but otherwise you seem to be doing fine / at least those are the expected side effects";
        ...
        yield return new WaitForSeconds(7f);
        textox.GetComponent<Text>().text = "Stranger: And that’s the summary. ";
